...
`You will be reading a passage and then writing a list of facts. Please enumerate the facts along with their truth value. Each fact in your response has the format: [<Fact>, <Truth Value>]. Within this format, the <Fact> is a fact from the passage, and <Truth Value> is either 'true', 'false', or 'unsure' Each fact in your response should be a new line. For example, if the passage says "The sky is blue", you would write ["The sky is blue", true]. If the passage says "The sky is red", you would write ["The sky is red:", false]. Please respond with a list containing all facts in the passage, and nothing else except for the facts themselves. If you are unsure of the truth value of a fact, please write "unsure" instead of "true" or "false". The passage is:`

export const WIKIPEDIA_PROMPT = `You will be presented with a fact`
...
[<Message Name>, [<Field 1>, <Field 1 Type>, <Field 1 Instructions>], [<Field 2>, <Field 2 Type>, <Field 2 Instructions>], ...]

Here is an example message definition:

["Bird", ["Name", "string", "The name of the bird"], ["IsMigratory", "boolean", "Whether or not the bird is migratory."], ["Diet","string","What the bird eats, can be one of the following values: carnivore, omnivore, herbivore."]]
